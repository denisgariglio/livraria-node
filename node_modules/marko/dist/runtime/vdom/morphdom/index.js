...
var addComponentRootToKeyedElements = componentsUtil.al_;
...
var createFragmentNode = fragment.ak_;
...
function onNodeAdded(node, componentsContext) {
    if (node.nodeType === 1) {
        eventDelegation._Y_(node, componentsContext);
    }
}
...
function morphdom(fromNode, toNode, doc, componentsContext) {
    ...
    if (componentsContext) {
        globalComponentsContext = componentsContext.m_;
        isHydrate = globalComponentsContext._s_;
    }
    ...
    function insertVirtualComponentBefore(vComponent, referenceNode, referenceNodeParentEl, component, key, ownerComponent, parentComponent) {
        var rootNode = component.L_ = insertBefore(createFragmentNode(), referenceNode, referenceNodeParentEl);
        ...
        outer: while (curToNodeChild) {
            ...
            if (curToNodeType === COMPONENT_NODE) {
                ...
                if ((matchingFromComponent = existingComponentLookup[component.id]) === undefined) {
                    ...
                    if (matchingFromComponent.L_ !== curFromNodeChild) {
                        if (curFromNodeChild && (fromComponent = componentByDOMNode.get(curFromNodeChild)) && globalComponentsContext.r_[fromComponent.id] === undefined) {
                        ...
                        insertBefore(matchingFromComponent.L_, curFromNodeChild, fromNode);
                    } else {
                ...
                var keySequence = keySequences[referenceComponent.id] || (keySequences[referenceComponent.id] = globalComponentsContext._Q_());
                ...
                if (curFromNodeKey === curToNodeKey) {
                    ...
                    if ((matchingFromEl = referenceComponent.n_[curToNodeKey]) === undefined) {
            ...
            while (curFromNodeChild) {
                ...
                if (fromComponent = componentByDOMNode.get(curFromNodeChild)) {
                    ...
                    if (!globalComponentsContext.r_[fromComponent.id]) {
                        destroyComponent(fromComponent);
                    }
                ...
                if (curFromNodeKey) {
                    if (globalComponentsContext.p_[parentComponent.id + "-" + curFromNodeKey] === undefined) {
                        detachNode(curFromNodeChild, fromNode, ownerComponent);
                    }
                } else {
                    detachNode(curFromNodeChild, fromNode, ownerComponent);
    ...
    function morphEl(fromEl, vFromEl, toEl, toElKey, ownerComponent, parentComponent) {
        ...
        if (isHydrate === true && toElKey) {
            ...
            referenceComponent.n_[toElKey] = fromEl;
        }
        ...
        if (toElKey && globalComponentsContext.o_[parentComponent.id + "-" + toElKey] === true) {
