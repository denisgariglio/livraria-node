...
var resolveComponentKey = modernRenderer.am_;
var trackAsyncComponents = modernRenderer.ax_;
...
function createRendererFunc(templateRenderFunc, componentProps) {
    ...
    return function renderer(input, out, assignedId, renderingLogic) {
        ...
        component.aq_ = widgetBody || component.aq_ || w10NOOP;

        var componentDef = beginComponent(componentsContext, component, key, ownerComponentDef, isSplit, isFakeComponent);
        var parentLegacyComponentDef = componentsContext.aw_;
        componentsContext.aw_ = componentDef;
        ...
        componentsContext.aw_ = parentLegacyComponentDef;
    };
}
