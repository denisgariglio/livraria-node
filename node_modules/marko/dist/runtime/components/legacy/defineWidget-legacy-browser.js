...
module.exports = function defineWidget(def, renderer) {
    ...
    Object.defineProperty(proto, "el", {
        get: function () {
            return this.getEl("_wbind") || this.L_ && this.L_.firstChild;
            // eslint-disable-next-line no-constant-condition
        }
    });
    ...
    proto.onMount = function () {
        ...
        this.on("as_", function () {
            if (!self.ar_ && onBeforeUpdate) {
    ...
    proto.onUpdate = function () {
        ...
        if (onRender && this.at_) onRender.call(this, {});
        this.at_ = false;
        this.R_ = null;
    };
    ...
    if (renderer) {
        ...
        Component.renderer = proto._o_ = renderer;
