...
var createFragmentNode = require("../vdom/morphdom/fragment").ak_;
...
function hydrateComponentAndGetMount(componentDef, doc) {
    ...
    if (rootNode) {
        ...
        component.n_ = keyedElementsByComponentId[componentId] || {};
...
exports._N_ = initClientRendered;
exports.ah_ = initServerRendered;