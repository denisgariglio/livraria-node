...
function handleCustomEventWithMethodListener(component, targetMethodName, args, extraArgs) {
    ...
    var targetComponent = componentLookup[component.I_];
...
Component.prototype = componentProto = {
    ...
    subscribeTo: function (target) {
        ...
        var subscriptions = this.M_ || (this.M_ = new SubscriptionTracker());
        ...
        if (key) {
            ...
            if (!keyedElement) {
                ...
                if (keyedComponent) {
                    ...
                    return walkFragments(keyedComponent.L_);
    ...
    get _k_() {
        return this.W_ === true || this.K_ !== null && this.K_.W_ === true;
    },
    ...
    _q_: function (input, isHydrate) {
        ...
        globalComponentsContext._s_ = isHydrate;
    ...
    get els() {
        return (this.L_ ? this.L_.nodes : []).filter(function (el) {
